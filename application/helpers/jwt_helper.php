...
/**
	 ...
	 */
    static function decode($jwt, $verify = true, $key = "Heartbeat@2022") {
		$tks = explode('.', $jwt);
		if (count($tks) != 3) {
	 ...
	 */
	static function encode($payload, $key = "Heartbeat@2022", $algo = 'HS256') {
	 ...
	 */
	static function sign($msg, $key, $method = 'HS256') {
		$methods = array(
			'HS256' => 'sha256',
			'HS384' => 'sha384',
			'HS512' => 'sha512',
	 ...
	 * @return void
	 */
	static function _handleJsonError($errno) {
		$messages = array(
